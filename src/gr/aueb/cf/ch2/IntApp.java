...
public class IntApp {
    public static void main(String[] args) {
        ...
        System.out.printf("Type: %s, Size: %d bits, Min: %,d, Max %,d\n", Short.TYPE, Short.SIZE, Short.MIN_VALUE, Integer.MAX_VALUE);
        System.out.printf("Type: %s, Size: %d bits, Min: %,d, Max %,d", Long.TYPE, Long.SIZE, Long.MIN_VALUE, Long.MAX_VALUE);
